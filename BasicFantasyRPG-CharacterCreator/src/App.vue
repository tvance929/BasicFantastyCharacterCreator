    ...
    <div id="app">
        <div>
            ...
            <b-collapse id="collapse-1" class="mt-2">
                <b-card class="border border-secondary rounded floatingheader onepercent text-left charSheet"
                        id="characterSheet">
                    <b-container fluid>
                        <b-row class="my-1 pb-4">
                            <b-col>
                                <span class="font-weight-bolder">NAME:</span>
                                <span class="text-capitalize sheetField editable"
                                      contenteditable="true">{{character.name}}</span>
                            </b-col>
                            <b-col>
                                <span class="font-weight-bolder">PLAYER:</span>
                                <span class="text-capitalize sheetField editable"
                                      contenteditable="true">{{character.player}}</span>
                            </b-col>
                        </b-row>
                        <b-row class="my-1 pb-4">
                            <b-col>
                        ...
                        <b-row class="my-1 pb-4">
                            <b-col>
                                ...
                                <span class="text-capitalize sheetSmallField">{{character.abilities.strength}} {{character.abilities.strength != "" ? abilityBonus(character.abilities.strength) : ""}}</span>
                                <br />
                                <span class="font-weight-bolder abilityName">INT:</span>
                                <span class="text-capitalize sheetSmallField">{{character.abilities.intelligence}} {{character.abilities.intelligence != "" ? abilityBonus(character.abilities.intelligence) : ""}}</span>
                                <br />
                                <span class="font-weight-bolder abilityName">WIS:</span>
                                <span class="text-capitalize sheetSmallField">{{character.abilities.wisdom}} {{character.abilities.wisdom != "" ? abilityBonus(character.abilities.wisdom) : ""}}</span>
                                <br />
                                <span class="font-weight-bolder abilityName">DEX:</span>
                                <span class="text-capitalize sheetSmallField">{{character.abilities.dexterity}} {{character.abilities.dexterity != "" ? abilityBonus(character.abilities.dexterity) : ""}}</span>
                                <br />
                                <span class="font-weight-bolder abilityName">CON:</span>
                                <span class="text-capitalize sheetSmallField">{{character.abilities.constitution}} {{character.abilities.constitution != "" ? abilityBonus(character.abilities.constitution) : ""}}</span>
                                <br />
                                <span class="font-weight-bolder abilityName">CHA:</span>
                                <span class="text-capitalize sheetSmallField">{{character.abilities.charisma}} {{character.abilities.charisma != "" ? abilityBonus(character.abilities.charisma) : ""}}</span>
                            </b-col>
                            <b-col>
                        ...
                        <b-row class="my-1 pb-4">
                            ...
                            <b-col>
                                ...
                                <p class="ml-4">
                                    ...
                                    <span class="text-capitalize sheetSmallField pb-4">{{character.saves.dragonBreath}}</span>
                                    <br />
                        ...
                        <b-row>
                            <b-col>
                                <b-button variant="primary"
                                          size="lg"
                                          class="printerButton"
                                          v-on:click="printCharacterSheet()">PRINT SHEET</b-button>
                            </b-col>
                        </b-row>
                    </b-container>
                </b-card>
        ...
        <div class="border border-secondary rounded onepercent" v-if="currentsection == sections.RACE">
            ...
            <b-form-group>
                <b-form-radio-group id="radioGroupRaces"
                                    name="radioRaces"
                                    buttons
                                    :options="raceOptions"
                                    size="lg"
                                    ...
                                    v-on:input="setRace()"></b-form-radio-group>
            </b-form-group>
        ...
        <div class="border border-secondary rounded onepercent"
             v-if="currentsection == sections.ABILITIES">
            <h3>Set Ability Scores</h3>
            <span>
                Roll 3 D6 for each ability OR use the option of a Standard Array ( 15, 14, 13, 12, 10, 8).
                    ...
                    <b-col>
                        ...
                        <b-container fluid class="onepercent">
                            <b-row class="my-1">
                                ...
                                <b-col sm="10">
                                    <b-form-input id="abilityInputStrength"
                                                  size="lg"
                                                  ...
                                                  min="3"
                                                  max="18"                                                 
                                                  v-on:drop.native="dropped($event, abilities.STRENGTH)"></b-form-input>
                            ...
                            <b-row class="my-1">
                                ...
                                <b-col sm="10">
                                    <b-form-input id="abilityInputDexterity"
                                                  size="lg"
                                                  ...
                                                  min="3"
                                                  max="18"
                                                  v-on:drop.native="dropped($event, abilities.DEXTERITY)">></b-form-input>
                            ...
                            <b-row class="my-1">
                                ...
                                <b-col sm="10">
                                    <b-form-input id="abilityInputIntelligence"
                                                  size="lg"
                                                  ...
                                                  min="3"
                                                  max="18"
                                                  v-on:drop.native="dropped($event, abilities.INTELLIGENCE)">></b-form-input>
                            ...
                            <b-row class="my-1">
                                ...
                                <b-col sm="10">
                                    <b-form-input id="abilityInputWisdom"
                                                  size="lg"
                                                  ...
                                                  min="3"
                                                  max="18"
                                                  v-on:drop.native="dropped($event, abilities.WISDOM)">></b-form-input>
                            ...
                            <b-row class="my-1">
                                ...
                                <b-col sm="10">
                                    <b-form-input id="abilityInputConstitution"
                                                  size="lg"
                                                  ...
                                                  min="3"
                                                  max="18"
                                                  v-on:drop.native="dropped($event, abilities.CONSTITUTION)">></b-form-input>
                            ...
                            <b-row class="my-1">
                                ...
                                <b-col sm="10">
                                    <b-form-input id="abilityInputCharisma"
                                                  size="lg"
                                                  ...
                                                  min="3"
                                                  max="18"
                                                  v-on:drop.native="dropped($event, abilities.CHARISMA)">></b-form-input>
        ...
        <div v-if="currentsection==sections.CLASS" class="border border-secondary rounded onepercent">
            ...
            <b-container fluid>
                <b-row class="my-1">
                    <b-col>
                        <b-button v-on:click="showClass(classes.FIGHTER)"
                                  size="lg"
                                  v-bind:variant="classQualify(classes.FIGHTER) ? 'success' : ''">FIGHTER</b-button>
                        <b-button v-on:click="showClass(classes.CLERIC)"
                                  size="lg"
                                  v-bind:variant="classQualify(classes.CLERIC) ? 'success' : ''">CLERIC</b-button>
                        <b-button size="lg"
                                  v-bind:variant="classQualify(classes.MAGICUSER) ? 'success' : ''"
                                  v-on:click="showClass(classes.MAGICUSER)">MAGIC-USER</b-button>
                        <b-button v-on:click="showClass(classes.THIEF)"
                                  size="lg"
                                  v-bind:variant="classQualify(classes.THIEF) ? 'success' : ''">THIEF</b-button>
                        <b-button size="lg"
                                  v-bind:variant="classQualify(classes.MAGICUSER_FIGHTER) ? 'success' : ''"
                                  v-on:click="showClass(classes.MAGICUSER_FIGHTER)">MAGE-FIGHTER</b-button>
                        <b-button size="lg"
                                  v-bind:variant="classQualify(classes.MAGICUSER_THIEF) ? 'success' : ''"
                                  v-on:click="showClass(classes.MAGICUSER_THIEF)">MAGE-THIEF</b-button>
                    </b-col>
                </b-row>
                <b-row class="my-1">
                    <b-col>
            ...
            <b-row>
                <b-col>
                    <b-button variant="primary"
                              ...
                              v-on:click="changeSection('prev')">PREV</b-button>
                </b-col>
                <b-col>
                    <b-button variant="primary"
                              size="lg"
                              ...
                              v-if="currentsection != sections.FINAL">NEXT</b-button>
                </b-col>
            </b-row>
        </b-container>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            dropped: function (event, ability) {
                switch (ability) {
                    case this.abilities.STRENGTH:
                        this.character.abilities.strength = event.dataTransfer.getData("text");
                        break;
                    case this.abilities.DEXTERITY:
                        this.character.abilities.dexterity = event.dataTransfer.getData("text");
                        break;
                     case this.abilities.INTELLIGENCE:
                        this.character.abilities.intelligence = event.dataTransfer.getData("text");
                        break;
                    case this.abilities.WISDOM:
                        this.character.abilities.wisdom = event.dataTransfer.getData("text");
                        break;
                     case this.abilities.CONSTITUTION:
                        this.character.abilities.constitution = event.dataTransfer.getData("text");
                        break;
                    case this.abilities.CHARISMA:
                        this.character.abilities.charisma = event.dataTransfer.getData("text");
                        break;
                }
